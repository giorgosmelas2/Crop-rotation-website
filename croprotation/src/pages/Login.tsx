...
const Login = () => {
    ...
    const animationClass = activeTab === "login" ? style["slide-left"] : style["slide-right"];
        ...
        <section className={style.container}>
            <div className={style.green}>
                ...
                <div className={style.toggle_container}>
                    <button
                        className={`${style.toggle_btn} ${activeTab === "login" ? style.active : ""}`}
                        id="loginBtn"
                        onClick={() => setActiveTab("login")}>
                        Login
                    </button>
                    <button
                        className={`${style.toggle_btn} ${activeTab === "signup" ? style.active : ""}`}
                        id="signupBtn"
